...
export default function ExperianDispute() {
    ...
    var experianBorrowerName = bundledata.BundleComponent[6].TrueLinkCreditReportType.Borrower.BorrowerName[0].Name.first + " " + bundledata.BundleComponent[6].TrueLinkCreditReportType.Borrower.BorrowerName[0].Name.last
    var experianBorrowerAddress = bundledata.BundleComponent[6].TrueLinkCreditReportType.Borrower.BorrowerAddress[0].CreditAddress
    ...
    const sendEmail = () => {
        ...
        if (LetterObject) {
           ...
           <div id='userdetails'>
               <div id="useraddress">
                   <p id="username">${experianBorrowerName}</p>
                   <p>${experianBorrowerAddress.houseNumber + " " + experianBorrowerAddress.streetName}</p>
                                    ...
                                    <div className="tab-content" id="v-pills-tabContent">
                                        ...
                                        <div className="tab-pane fade show active" id="positive" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                            ...
                                            <Col lg={12} md={12}>
                                                <div className="tab-content" id="pills-tabContent">
                                                    {/* ************************ experian report ************************ */}
                                                    <div className="tab-pane fade show active" id="experian" role="tabpanel" aria-labelledby="pills-home-tab">
                                                        <Col lg={12} md={12}>
                                        ...
                                        <div className="tab-pane fade" id="negative" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                            ...
                                            <Col lg={12} md={12}>
                                                <div className="tab-content" id="pills-tabContent">
                                                    {/* ************************ experian report ************************ */}
                                                    <div className="tab-pane fade show active" id="experian1" role="tabpanel" aria-labelledby="pills-home-tab">
                                                        <Col lg={12} md={12}>
                                                            <div className="accordian_content mt-3">
                                                                <Accordion>
                                                                    <Accordion.Item eventKey="0">
                                        ...
                                        <div className="tab-pane fade" id="all" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                                            ...
                                            <Col lg={12} md={12}>
                                                <div className="tab-content" id="pills-tabContent">
                                                    {/* ************************ experian report ************************ */}
                                                    <div className="tab-pane fade show active" id="experian4" role="tabpanel" aria-labelledby="pills-home-tab">
                                                        <Col lg={12} md={12}>
                                                            <div className="accordian_content mt-3">
                                                                <Accordion>
                                                                    <Accordion.Item eventKey="0">
